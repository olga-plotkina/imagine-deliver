...
module.exports = env => {
  ...
  const webpackConfig = {
    ...
    plugins: [
      ...
      new HtmlWebpackPlugin({
        template: './public/case-studies-landing.html',
        filename: 'case-studies-landing.html',
        chunks: ['case-studies-landing'],
        // minify: false,
      }),
      new HtmlWebpackPlugin({
      ...
      new HtmlWebpackPlugin({
        template: './public/product-landing-guides.html',
        filename: 'product-landing-guides.html',
